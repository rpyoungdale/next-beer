...
Comment.create(content: "This is a great beer!", beer_id: 1)
Comment.create(content: "Fantastic!", beer_id: 2)
Comment.create(content: "Great brew!", beer_id: 16)
Comment.create(content: "Would highly recommend!", beer_id: 13)
Comment.create(content: "Super smooth!", beer_id: 3)
Comment.create(content: "Definitely try this one!", beer_id: 3)
Comment.create(content: "Not the greatest", beer_id: 3)
Comment.create(content: "I've had better!", beer_id: 4)
Comment.create(content: "This one is decent!", beer_id: 4)
Comment.create(content: "I cant belive this brewery would sell this. I have never had a worse beer in my life. Please cease production immediately. Suing for emotional damage I got from drinking this beer!", beer_id: 7)
Comment.create(content: "Just an average brewski", beer_id: 8)
Comment.create(content: "Good flavour!", beer_id: 9)
Comment.create(content: "Love the hops!", beer_id: 10)
Comment.create(content: "Such a decent beer. Really middle of the road.", beer_id: 5)
Comment.create(content: "Cant get any more average than this.", beer_id: 5)
Comment.create(content: "Would I drink it again? Yes. Is it the best I've had? No.", beer_id: 9)
Comment.create(content: "Phenomenal beer!", beer_id: 6)

Restaurant.create(name: "Buffalo Wild Wings", address: "234 Shotgun Street", logo: "https://image.shutterstock.com/image-vector/black-restaurant-logo-260nw-787714876.jpg" )
Restaurant.create(name: "Applebees", address: "384 Pilsner Point", logo: "https://image.shutterstock.com/image-vector/black-restaurant-logo-260nw-787714876.jpg")
Restaurant.create(name: "Chili's", address: "634 Lager Lane", logo: "https://image.shutterstock.com/image-vector/black-restaurant-logo-260nw-787714876.jpg")
Restaurant.create(name: "Olive Garden", address: "495 Ale Avenue", logo: "https://image.shutterstock.com/image-vector/black-restaurant-logo-260nw-787714876.jpg")
Restaurant.create(name: "Kyle & Ryan's Brewhaus", address: "262 Brewski Blvd", logo: "https://image.shutterstock.com/image-vector/black-restaurant-logo-260nw-787714876.jpg")

RestaurantBeer.create(restaurant_id: 1, beer_id: 1)
RestaurantBeer.create(restaurant_id: 1, beer_id: 2)
RestaurantBeer.create(restaurant_id: 1, beer_id: 3)
RestaurantBeer.create(restaurant_id: 1, beer_id: 4)
RestaurantBeer.create(restaurant_id: 1, beer_id: 5)
RestaurantBeer.create(restaurant_id: 1, beer_id: 6)
RestaurantBeer.create(restaurant_id: 1, beer_id: 7)
RestaurantBeer.create(restaurant_id: 2, beer_id: 7)
RestaurantBeer.create(restaurant_id: 2, beer_id: 18)
RestaurantBeer.create(restaurant_id: 2, beer_id: 8)
RestaurantBeer.create(restaurant_id: 2, beer_id: 9)
RestaurantBeer.create(restaurant_id: 2, beer_id: 10)
RestaurantBeer.create(restaurant_id: 2, beer_id: 11)
RestaurantBeer.create(restaurant_id: 3, beer_id: 7)
RestaurantBeer.create(restaurant_id: 3, beer_id: 8)
RestaurantBeer.create(restaurant_id: 3, beer_id: 2)
RestaurantBeer.create(restaurant_id: 3, beer_id: 12)
RestaurantBeer.create(restaurant_id: 3, beer_id: 13)
RestaurantBeer.create(restaurant_id: 3, beer_id: 14)
RestaurantBeer.create(restaurant_id: 3, beer_id: 15)
RestaurantBeer.create(restaurant_id: 3, beer_id: 16)
RestaurantBeer.create(restaurant_id: 4, beer_id: 17)
RestaurantBeer.create(restaurant_id: 4, beer_id: 18)
RestaurantBeer.create(restaurant_id: 4, beer_id: 19)
RestaurantBeer.create(restaurant_id: 4, beer_id: 20)
RestaurantBeer.create(restaurant_id: 4, beer_id: 21)
RestaurantBeer.create(restaurant_id: 4, beer_id: 22)
RestaurantBeer.create(restaurant_id: 4, beer_id: 23)
RestaurantBeer.create(restaurant_id: 4, beer_id: 25)
RestaurantBeer.create(restaurant_id: 4, beer_id: 26)
RestaurantBeer.create(restaurant_id: 5, beer_id: 18)
RestaurantBeer.create(restaurant_id: 5, beer_id: 4)
RestaurantBeer.create(restaurant_id: 5, beer_id: 6)
RestaurantBeer.create(restaurant_id: 5, beer_id: 8)
RestaurantBeer.create(restaurant_id: 5, beer_id: 16)
RestaurantBeer.create(restaurant_id: 5, beer_id: 26)
